User.create!([
  {email: "zair@blog.com", password: "pass", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, confirmation_token: nil, confirmed_at: "2019-07-17 14:57:00", confirmation_sent_at: nil, isadmin: false, username: "zair"},
  {email: "user2@blog.com", password: "pass", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, confirmation_token: nil, confirmed_at: "2019-07-17 14:57:00", confirmation_sent_at: nil, isadmin: false, username: "user2"},
  {email: "hello@gmail.com", password: "pass", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, confirmation_token: "Tw1mh8mpsq-sSkM_h12x", confirmed_at: nil, confirmation_sent_at: "2019-07-19 07:46:48", isadmin: false, username: "hello"},
  {email: "hitachi.xoxoxo@gmail.com", password: "pass", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, confirmation_token: "cS_8V2tztxq9NyFjBQu4", confirmed_at: "2019-07-19 12:48:27", confirmation_sent_at: "2019-07-19 12:47:20", isadmin: false, username: "china"},
  {email: "hello1@gmail.com", password: "pass", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, confirmation_token: "ve4n5CzExbGk8SqpeikH", confirmed_at: nil, confirmation_sent_at: "2019-07-19 13:47:48", isadmin: false, username: "hello1"},
  {email: "test@test.com", password: "pass", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, confirmation_token: "i99NmPLXbkp-H64yTu2N", confirmed_at: nil, confirmation_sent_at: "2019-07-23 07:13:45", isadmin: false, username: "test"},
  {email: "muhammadzair@techcreatix.com", password: "admin", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, confirmation_token: "aGZq4-b7Sx_GmgyBNRrH", confirmed_at: "2019-07-23 13:54:17", confirmation_sent_at: "2019-07-23 13:53:19", isadmin: true, username: "admin"},
  {email: "username@blog.com", password: "pass", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, confirmation_token: nil, confirmed_at: nil, confirmation_sent_at: nil, isadmin: false, username: "username "}
])
Post.create!([
