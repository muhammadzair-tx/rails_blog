User.create!([
  {email: "zair@blog.com", encrypted_password: "$2a$11$wFaJWbsW7SRNE9L6kuA26.O5f5GVPpigWo00fYWYaQRX6hbUPCN1i", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, confirmation_token: nil, confirmed_at: "2019-07-17 14:57:00", confirmation_sent_at: nil, isadmin: false, username: "zair"},
  {email: "user2@blog.com", encrypted_password: "$2a$11$ZjYkDOPhDlZhYb.xuG3S3.0Kuh/i9/TgvVSthuLJ/7TfY1UwaElZ6", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, confirmation_token: nil, confirmed_at: "2019-07-17 14:57:00", confirmation_sent_at: nil, isadmin: false, username: "user2"},
  {email: "hello@gmail.com", encrypted_password: "$2a$11$Yo5y.DustBWJ8uWRs4WqW.ndx.GarZbSYP11Cj7Df36amURNccjZC", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, confirmation_token: "Tw1mh8mpsq-sSkM_h12x", confirmed_at: nil, confirmation_sent_at: "2019-07-19 07:46:48", isadmin: false, username: "hello"},
  {email: "hitachi.xoxoxo@gmail.com", encrypted_password: "$2a$11$WjjhZH2aEzLYHqSrUO6tFO.ScR8V2LSelKr8RFAOZaG4eFxBAXvmu", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, confirmation_token: "cS_8V2tztxq9NyFjBQu4", confirmed_at: "2019-07-19 12:48:27", confirmation_sent_at: "2019-07-19 12:47:20", isadmin: false, username: "china"},
  {email: "hello1@gmail.com", encrypted_password: "$2a$11$esHPLgDpwQIhF4WbwWsjreEnHSA0ZLNlAd2ffQIIRen9yZ3w2y3d6", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, confirmation_token: "ve4n5CzExbGk8SqpeikH", confirmed_at: nil, confirmation_sent_at: "2019-07-19 13:47:48", isadmin: false, username: "hello1"},
  {email: "test@test.com", encrypted_password: "$2a$11$od0FCL.cUPdZv09ndWdUEuL303zQFybOLl1HQevKz4elgy6TjHo3W", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, confirmation_token: "i99NmPLXbkp-H64yTu2N", confirmed_at: nil, confirmation_sent_at: "2019-07-23 07:13:45", isadmin: false, username: "test"},
  {email: "muhammadzair@techcreatix.com", encrypted_password: "$2a$11$MNR4VnytjeeVetGrKhIjieRu.v6/QRAmU2Zk0xV5To5Bd.PHZkxAW", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, confirmation_token: "aGZq4-b7Sx_GmgyBNRrH", confirmed_at: "2019-07-23 13:54:17", confirmation_sent_at: "2019-07-23 13:53:19", isadmin: true, username: "admin"},
  {email: "username@blog.com", encrypted_password: "$2a$11$mYX.jAPF9c69K/ilfCkq0OEfwuidWSBAWTYFMoFa5Xk3KTeLfFnEK", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, confirmation_token: nil, confirmed_at: nil, confirmation_sent_at: nil, isadmin: false, username: "username "}
])
Category.create!([
  {name: "Tech"},
  {name: "Cricket"},
...
Like.create!([
  {post_id: 2, user_id: 10},
  {post_id: 4, user_id: 1},
  {post_id: 3, user_id: 1},
  {post_id: 4, user_id: 10},
  {post_id: 3, user_id: 10}
])
Post.create!([
